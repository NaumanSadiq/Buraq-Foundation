...
@section('body')
    <form class="form fv-plugins-bootstrap5 fv-plugins-framework" action="{{route('superAdmin.store.data.entry.operator')}}" method="post">
        @csrf
        <div class="col-6 p-10 bg-white">
            <div class="mb-13 text-center">
                <h1 class="mb-3">Create Data Entry Operator</h1>
            </div>
